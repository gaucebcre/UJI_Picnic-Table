...
Shader "ALP/Cutout Translucency Wind"
{
	Properties
	{
		...
		[DE_DrawerCategory(THICKNESS,true,_ThicknessMapEnable,0,0)]_CATEGORY_THICKNESS("CATEGORY_THICKNESS", Float) = 0
		[DE_DrawerToggleLeft]_ThicknessMapEnable("ENABLE THICKNESS", Float) = 0
		[DE_DrawerToggleNoKeyword]_ThicknessMapInverted("Thickness Map Inverted", Float) = 0
		[NoScaleOffset][DE_DrawerTextureSingleLine]_ThicknessMap("Thickness Map", 2D) = "white" {}
		_ThicknessIntensity("Thickness Intensity", Range( 0 , 1.5)) = 0.5
		...
		[DE_DrawerSpace(10)]_SPACE_THICKNESS("SPACE_THICKNESS", Float) = 0
		[DE_DrawerCategory(DIFFUSION PROFILE,true,_DiffusionProfileHash,0,0)]_CATEGORY_DIFFUSIONPROFILE("CATEGORY_DIFFUSION PROFILE", Float) = 1
		...
		[DE_DrawerSpace(10)]_SPACE_DIFFUSIONPROFILE("SPACE_DIFFUSIONPROFILE", Float) = 0
		[DE_DrawerCategory(TRANSMISSION MASK,true,_TransmissionMaskEnable,0,0)]_CATEGORY_TRANSMISSIONMASK("CATEGORY_TRANSMISSION MASK", Float) = 0
		[DE_DrawerToggleLeft]_TransmissionMaskEnable("ENABLE TRANSMISSION MASK", Float) = 0
		[DE_DrawerTextureSingleLine]_TransmissionMaskMap("Transmission Mask Map", 2D) = "white" {}
		_TransmissionMaskStrength("Transmission Strength", Range( 0 , 1)) = 1
		[DE_DrawerSpace(10)]_SPACE_TRANSMISSIONMASK("SPACE_TRANSMISSIONMASK", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _SPACE_TRANSMISSIONMASK;
			float _CATEGORY_TRANSMISSIONMASK;
			half _TransmissionMaskEnable;
			half _TransmissionMaskStrength;
			float _SPACE_THICKNESS;
			half _NormalStrength;
			float _CATEGORY_THICKNESS;
			...
			float _CATEGORY_DIFFUSIONPROFILE;
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VERTEX_POSITION_MATRIX2352_g58567 = mul( GetObjectToWorldMatrix(), float4( inputMesh.positionOS , 0.0 ) ).xyz;
				...
				transform3073_g58567.xyz = GetAbsolutePositionWS((transform3073_g58567).xyz);
				...
				float FUNC_Angle2470_g58567 = ( _WIND_STRENGHT2400_g58567 * ( 1.0 + sin( ( ( ( ( _WIND_RANDOM_OFFSET2244_g58567 * 2.0 ) + _WIND_TUBULENCE_RANDOM2274_g58567 ) - ( VERTEX_POSITION_MATRIX2352_g58567.z / 50.0 ) ) - ( inputMesh.ase_color.r / 20.0 ) ) ) ) * sqrt( inputMesh.ase_color.r ) * _WIND_PULSE2421_g58567 );
				...
				float3 VERTEX_POSITION2282_g58567 = ( mul( GetWorldToObjectMatrix(), float4( appendResult2235_g58567 , 0.0 ) ).xyz - inputMesh.positionOS );
				float3 break2518_g58567 = VERTEX_POSITION2282_g58567;
				half FUNC_SinFunction2336_g58567 = sin( ( ( _WIND_RANDOM_OFFSET2244_g58567 * 200.0 * ( 0.2 + inputMesh.ase_color.g ) ) + ( inputMesh.ase_color.g * 10.0 ) + _WIND_TUBULENCE_RANDOM2274_g58567 + ( VERTEX_POSITION_MATRIX2352_g58567.z / 2.0 ) ) );
				...
				float3 appendResult2480_g58567 = (float3(break2518_g58567.x , ( break2518_g58567.y + ( FUNC_SinFunction2336_g58567 * inputMesh.ase_color.b * ( FUNC_Angle2470_g58567 + ( _WIND_STRENGHT2400_g58567 / 200.0 ) ) * _WIND_TUBULENCE2442_g58567 ) ) , break2518_g58567.z));
				float3 VERTEX_LEAF2396_g58567 = appendResult2480_g58567;
				float3 m_Leaf2439_g58567 = VERTEX_LEAF2396_g58567;
				float3 VERTEX_PALM2310_g58567 = ( ( FUNC_SinFunction2336_g58567 * inputMesh.ase_color.b * ( FUNC_Angle2470_g58567 + ( _WIND_STRENGHT2400_g58567 / 200.0 ) ) * _WIND_TUBULENCE2442_g58567 ) + VERTEX_POSITION2282_g58567 );
				float3 m_Palm2439_g58567 = VERTEX_PALM2310_g58567;
				float3 break2486_g58567 = VERTEX_POSITION2282_g58567;
				float temp_output_2514_0_g58567 = ( FUNC_SinFunction2336_g58567 * inputMesh.ase_color.b * ( FUNC_Angle2470_g58567 + ( _WIND_STRENGHT2400_g58567 / 200.0 ) ) );
				...
				float3 VERTEX_IVY997_g58567 = ( ( ( cos( temp_output_2613_0_g58567 ) + ( -0.3193 * PI ) ) * inputMesh.normalOS * 0.2 * ( FUNC_SinFunction2336_g58567 * inputMesh.ase_color.b ) ) + ( sin( temp_output_2613_0_g58567 ) * cross( inputMesh.normalOS , inputMesh.tangentOS.xyz ) * 0.2 ) );
				...
				float2 m_UV080_g58645 = inputMesh.ase_texcoord.xy;
				float2 m_UV180_g58645 = inputMesh.uv1.xy;
				float2 m_UV280_g58645 = inputMesh.uv2.xy;
				float2 m_UV380_g58645 = inputMesh.ase_texcoord3.xy;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = vertexToFrag70_g58645;
						...
						)
			{
				...
				float2 vertexToFrag70_g58645 = packedInput.ase_texcoord5.xy;
				...
				float3 p1_g58580 = ( ase_worldPos * _ColorShiftWorldSpaceNoiseShift );
				float localSimpleNoise3D1_g58580 = SimpleNoise3D( p1_g58580 );
				float4 transform374_g58579 = mul(GetObjectToWorldMatrix(),packedInput.ase_texcoord6);
				transform374_g58579.xyz = GetAbsolutePositionWS((transform374_g58579).xyz);
				...
				float m_VertexColor168_g58579 = ( packedInput.ase_color.g - 0.5 );
				float m_VertexNormal168_g58579 = ( packedInput.ase_normal.y - 0.5 );
				...
				float2 uv_ColorShiftMaskMap = packedInput.ase_texcoord5.zw * _ColorShiftMaskMap_ST.xy + _ColorShiftMaskMap_ST.zw;
				float4 transform376_g58579 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord6.xyz , 0.0 ));
				transform376_g58579.xyz = GetAbsolutePositionWS((transform376_g58579).xyz);
				...
				float2 appendResult2645_g58570 = (float2(V.xy));
				float3 appendResult2644_g58570 = (float3(appendResult2645_g58570 , ( V.z / 1.06 )));
				float3 break2680_g58570 = unpack1891_g58570;
				float3 ase_worldBitangent = packedInput.ase_texcoord7.xyz;
				float3 normalizeResult2641_g58570 = normalize( ( ( tangentWS.xyz * break2680_g58570.x ) + ( ase_worldBitangent * break2680_g58570.y ) + ( normalWS * break2680_g58570.z ) ) );
				...
				float3 temp_cast_7 = (fresnelNode2685_g58570).xxx;
				float3 lerpResult2636_g58570 = lerp( temp_output_2693_0_g58570 , ( temp_output_2693_0_g58570 - temp_cast_7 ) , _SmoothnessFresnelEnable);
				...
				float lerpResult3414_g58570 = lerp( 1.0 , packedInput.ase_color.a , _OcclusionStrengthAO);
				float3 temp_cast_9 = (lerpResult3414_g58570).xxx;
				float3 lerpResult2709_g58570 = lerp( lerpResult3415_g58570 , temp_cast_9 , _OcclusionSource);
				...
				float dotResult74_g58616 = dot( normalizeResult96_g58620 , V );
				...
				float3 temp_output_114_0_g58571 = ( (SAMPLE_TEXTURE2D( _ThicknessMap, sampler_MainTex, UV213_g58570 )).rgb / max( _ThicknessFeather , 1E-05 ) );
				float3 lerpResult145_g58571 = lerp( temp_output_114_0_g58571 , ( 1.0 - temp_output_114_0_g58571 ) , _ThicknessMapInverted);
				float3 NORMAL_OUT1491_g58570 = unpack1891_g58570;
				...
				float3 tanNormal1607_g58570 = NORMAL_OUT1491_g58570;
				float3 worldNormal1607_g58570 = float3(dot(tanToWorld0,tanNormal1607_g58570), dot(tanToWorld1,tanNormal1607_g58570), dot(tanToWorld2,tanNormal1607_g58570));
				float3 temp_output_68_0_g58571 = ( worldNormal1607_g58570 * _ThicknessDistortion );
				float3 normalizeResult63_g58571 = normalize( ( -( -_DirectionalLightDatas[0].forward + temp_output_68_0_g58571 ) * temp_output_68_0_g58571 ) );
				float dotResult74_g58571 = dot( V , normalizeResult63_g58571 );
				float3 lerpResult119_g58571 = lerp( float3( 0,0,0 ) , ( saturate( ( lerpResult145_g58571 + saturate( ( pow( saturate( max( dotResult74_g58571 , 0.0 ) ) , _ThicknessAngle ) * _ThicknessScattering ) ) ) ) * _ThicknessIntensity ) , ( _ThicknessMapEnable + ( ( _CATEGORY_THICKNESS + _SPACE_THICKNESS ) * 0.0 ) ));
				
				float3 temp_cast_14 = (1.0).xxx;
				float2 uv_TransmissionMaskMap = packedInput.ase_texcoord5.zw * _TransmissionMaskMap_ST.xy + _TransmissionMaskMap_ST.zw;
				float3 lerpResult5_g58669 = lerp( temp_cast_14 , ( (SAMPLE_TEXTURE2D( _TransmissionMaskMap, sampler_TransmissionMaskMap, uv_TransmissionMaskMap )).rgb * _TransmissionMaskStrength ) , ( _TransmissionMaskEnable + ( ( _CATEGORY_TRANSMISSIONMASK + _SPACE_TRANSMISSIONMASK ) * 0.0 ) ));
				
				surfaceDescription.BaseColor = lerpResult393_g58579;
				surfaceDescription.Normal = temp_output_24_0_g58586;
				...
				surfaceDescription.Smoothness = saturate( lerpResult2636_g58570 ).x;
				surfaceDescription.Occlusion = temp_output_2730_0_g58570.x;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = lerpResult119_g58571.x;
				#endif
				...
				#ifdef _MATERIAL_FEATURE_TRANSMISSION
				surfaceDescription.TransmissionMask = lerpResult5_g58669.x;
				#endif

				#if defined( _MATERIAL_FEATURE_SUBSURFACE_SCATTERING ) || defined( _MATERIAL_FEATURE_TRANSMISSION )
				surfaceDescription.DiffusionProfile = ( _DiffusionProfileHash + ( ( _CATEGORY_DIFFUSIONPROFILE + _SPACE_DIFFUSIONPROFILE ) * 0.0 ) );
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float m_switch80_g58645 = _UVMode;
				float2 m_UV080_g58645 = inputMesh.uv0.xy;
				float2 m_UV180_g58645 = inputMesh.uv1.xy;
				float2 m_UV280_g58645 = inputMesh.uv2.xy;
				float2 m_UV380_g58645 = inputMesh.uv3.xy;
				float2 localfloat2switchUVMode80_g58645 = float2switchUVMode80_g58645( m_switch80_g58645 , m_UV080_g58645 , m_UV180_g58645 , m_UV280_g58645 , m_UV380_g58645 );
				float2 temp_output_1955_0_g58570 = (_MainUVs).xy;
				float2 temp_output_1953_0_g58570 = (_MainUVs).zw;
				float2 Offset235_g58645 = temp_output_1953_0_g58570;
				float2 temp_output_41_0_g58645 = ( ( localfloat2switchUVMode80_g58645 * temp_output_1955_0_g58570 ) + Offset235_g58645 );
				float2 vertexToFrag70_g58645 = temp_output_41_0_g58645;
				outputPackedVaryingsMeshToPS.ase_texcoord2.xy = vertexToFrag70_g58645;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 temp_output_1923_0_g58570 = (_BaseColor).rgb;
				float2 vertexToFrag70_g58645 = packedInput.ase_texcoord2.xy;
				float2 UV213_g58570 = vertexToFrag70_g58645;
				float4 tex2DNode2048_g58570 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g58570 );
				float3 ALBEDO_RGBA1381_g58570 = (tex2DNode2048_g58570).rgb;
				float3 temp_output_3_0_g58570 = ( temp_output_1923_0_g58570 * ALBEDO_RGBA1381_g58570 * _Brightness );
				...
				float3 p1_g58580 = ( ase_worldPos * _ColorShiftWorldSpaceNoiseShift );
				float localSimpleNoise3D1_g58580 = SimpleNoise3D( p1_g58580 );
				float4 transform374_g58579 = mul(GetObjectToWorldMatrix(),packedInput.ase_texcoord4);
				transform374_g58579.xyz = GetAbsolutePositionWS((transform374_g58579).xyz);
				float m_WorldSpace168_g58579 = ( ( localSimpleNoise3D1_g58580 / _ColorShiftNoiseScale ) - ( ( (transform374_g58579).w - _ColorShiftWorldSpaceOffset ) / _ColorShiftWorldSpaceDistance ) );
				float m_VertexColor168_g58579 = ( packedInput.ase_color.g - 0.5 );
				float m_VertexNormal168_g58579 = ( packedInput.ase_normal.y - 0.5 );
				...
				float VALUE219_g58579 = temp_output_112_0_g58579;
				float3 hsvTorgb126_g58579 = HSVToRGB( float3(( ( saturate( localColorShift_Modefloatswitch168_g58579 ) * _ColorShiftVariation ) + _ColorShiftVariationRGB + hsvTorgb122_g58579 ).x,( _ColorShiftSaturation * hsvTorgb122_g58579.y ),( hsvTorgb122_g58579.z + ( VALUE219_g58579 / 40 ) )) );
				float2 uv_ColorShiftMaskMap = packedInput.ase_texcoord2.zw * _ColorShiftMaskMap_ST.xy + _ColorShiftMaskMap_ST.zw;
				float4 transform376_g58579 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord4.xyz , 0.0 ));
				transform376_g58579.xyz = GetAbsolutePositionWS((transform376_g58579).xyz);
				float3 temp_output_337_0_g58579 = saturate( ( 1.0 - ( (( SAMPLE_TEXTURE2D( _ColorShiftMaskMap, sampler_MainTex, uv_ColorShiftMaskMap ) * transform376_g58579 )).rgb / max( _ColorShiftMaskFuzziness , 1E-05 ) ) ) );
				float3 lerpResult314_g58579 = lerp( hsvTorgb126_g58579 , BaseColor136_g58579 , temp_output_337_0_g58579);
				float3 lerpResult311_g58579 = lerp( BaseColor136_g58579 , hsvTorgb126_g58579 , temp_output_337_0_g58579);
				...
				float2 appendResult2645_g58570 = (float2(ase_worldViewDir.xy));
				float3 appendResult2644_g58570 = (float3(appendResult2645_g58570 , ( ase_worldViewDir.z / 1.06 )));
				...
				float3 normalizeResult2641_g58570 = normalize( ( ( ase_worldTangent * break2680_g58570.x ) + ( ase_worldBitangent * break2680_g58570.y ) + ( ase_worldNormal * break2680_g58570.z ) ) );
				float3 Normal_Per_Pixel2690_g58570 = normalizeResult2641_g58570;
				float fresnelNdotV2685_g58570 = dot( normalize( Normal_Per_Pixel2690_g58570 ), appendResult2644_g58570 );
				float fresnelNode2685_g58570 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g58570 , 0.0001 ), _SmoothnessFresnelPower ) );
				float3 temp_cast_7 = (fresnelNode2685_g58570).xxx;
				...
				float3 temp_output_68_0_g58571 = ( worldNormal1607_g58570 * _ThicknessDistortion );
				float3 normalizeResult63_g58571 = normalize( ( -( -_DirectionalLightDatas[0].forward + temp_output_68_0_g58571 ) * temp_output_68_0_g58571 ) );
				float dotResult74_g58571 = dot( ase_worldViewDir , normalizeResult63_g58571 );
				float3 lerpResult119_g58571 = lerp( float3( 0,0,0 ) , ( saturate( ( lerpResult145_g58571 + saturate( ( pow( saturate( max( dotResult74_g58571 , 0.0 ) ) , _ThicknessAngle ) * _ThicknessScattering ) ) ) ) * _ThicknessIntensity ) , ( _ThicknessMapEnable + ( ( _CATEGORY_THICKNESS + _SPACE_THICKNESS ) * 0.0 ) ));
				
				float3 temp_cast_14 = (1.0).xxx;
				float2 uv_TransmissionMaskMap = packedInput.ase_texcoord2.zw * _TransmissionMaskMap_ST.xy + _TransmissionMaskMap_ST.zw;
				float3 lerpResult5_g58669 = lerp( temp_cast_14 , ( (SAMPLE_TEXTURE2D( _TransmissionMaskMap, sampler_TransmissionMaskMap, uv_TransmissionMaskMap )).rgb * _TransmissionMaskStrength ) , ( _TransmissionMaskEnable + ( ( _CATEGORY_TRANSMISSIONMASK + _SPACE_TRANSMISSIONMASK ) * 0.0 ) ));
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float m_switch80_g58645 = _UVMode;
				float2 m_UV080_g58645 = inputMesh.ase_texcoord.xy;
				float2 m_UV180_g58645 = inputMesh.ase_texcoord1.xy;
				float2 m_UV280_g58645 = inputMesh.ase_texcoord2.xy;
				float2 m_UV380_g58645 = inputMesh.ase_texcoord3.xy;
				float2 localfloat2switchUVMode80_g58645 = float2switchUVMode80_g58645( m_switch80_g58645 , m_UV080_g58645 , m_UV180_g58645 , m_UV280_g58645 , m_UV380_g58645 );
				float2 temp_output_1955_0_g58570 = (_MainUVs).xy;
				float2 temp_output_1953_0_g58570 = (_MainUVs).zw;
				...
				float2 temp_output_41_0_g58645 = ( ( localfloat2switchUVMode80_g58645 * temp_output_1955_0_g58570 ) + Offset235_g58645 );
				float2 vertexToFrag70_g58645 = temp_output_41_0_g58645;
				outputPackedVaryingsMeshToPS.ase_texcoord1.xy = vertexToFrag70_g58645;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 vertexToFrag70_g58645 = packedInput.ase_texcoord1.xy;
				float2 UV213_g58570 = vertexToFrag70_g58645;
				float4 tex2DNode2048_g58570 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g58570 );
				float temp_output_22_0_g58616 = tex2DNode2048_g58570.a;
				float temp_output_22_0_g58618 = temp_output_22_0_g58616;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 temp_output_41_0_g58645 = ( ( localfloat2switchUVMode80_g58645 * temp_output_1955_0_g58570 ) + Offset235_g58645 );
				float2 vertexToFrag70_g58645 = temp_output_41_0_g58645;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = vertexToFrag70_g58645;
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 vertexToFrag70_g58645 = packedInput.ase_texcoord3.xy;
				float2 UV213_g58570 = vertexToFrag70_g58645;
				float4 NORMAL_RGBA1382_g58570 = SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UV213_g58570 );
				float3 unpack1891_g58570 = UnpackNormalScale( NORMAL_RGBA1382_g58570, _NormalStrength );
				unpack1891_g58570.z = lerp( 1, unpack1891_g58570.z, saturate(_NormalStrength) );
				...
				float fresnelNdotV2685_g58570 = dot( normalize( Normal_Per_Pixel2690_g58570 ), appendResult2644_g58570 );
				float fresnelNode2685_g58570 = ( 0.0 + ( 1.0 - _SmoothnessFresnelScale ) * pow( max( 1.0 - fresnelNdotV2685_g58570 , 0.0001 ), _SmoothnessFresnelPower ) );
				float3 temp_cast_3 = (fresnelNode2685_g58570).xxx;
				float3 lerpResult2636_g58570 = lerp( temp_output_2693_0_g58570 , ( temp_output_2693_0_g58570 - temp_cast_3 ) , _SmoothnessFresnelEnable);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float2 temp_output_41_0_g58645 = ( ( localfloat2switchUVMode80_g58645 * temp_output_1955_0_g58570 ) + Offset235_g58645 );
				float2 vertexToFrag70_g58645 = temp_output_41_0_g58645;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xy = vertexToFrag70_g58645;
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 temp_output_1923_0_g58570 = (_BaseColor).rgb;
				float2 vertexToFrag70_g58645 = packedInput.ase_texcoord7.xy;
				float2 UV213_g58570 = vertexToFrag70_g58645;
				float4 tex2DNode2048_g58570 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UV213_g58570 );
				float3 ALBEDO_RGBA1381_g58570 = (tex2DNode2048_g58570).rgb;
				float3 temp_output_3_0_g58570 = ( temp_output_1923_0_g58570 * ALBEDO_RGBA1381_g58570 * _Brightness );
				...
				float3 p1_g58580 = ( ase_worldPos * _ColorShiftWorldSpaceNoiseShift );
				float localSimpleNoise3D1_g58580 = SimpleNoise3D( p1_g58580 );
				float4 transform374_g58579 = mul(GetObjectToWorldMatrix(),packedInput.ase_texcoord8);
				transform374_g58579.xyz = GetAbsolutePositionWS((transform374_g58579).xyz);
				float m_WorldSpace168_g58579 = ( ( localSimpleNoise3D1_g58580 / _ColorShiftNoiseScale ) - ( ( (transform374_g58579).w - _ColorShiftWorldSpaceOffset ) / _ColorShiftWorldSpaceDistance ) );
				float m_VertexColor168_g58579 = ( packedInput.ase_color.g - 0.5 );
				float m_VertexNormal168_g58579 = ( packedInput.ase_normal.y - 0.5 );
				...
				float VALUE219_g58579 = temp_output_112_0_g58579;
				float3 hsvTorgb126_g58579 = HSVToRGB( float3(( ( saturate( localColorShift_Modefloatswitch168_g58579 ) * _ColorShiftVariation ) + _ColorShiftVariationRGB + hsvTorgb122_g58579 ).x,( _ColorShiftSaturation * hsvTorgb122_g58579.y ),( hsvTorgb122_g58579.z + ( VALUE219_g58579 / 40 ) )) );
				float2 uv_ColorShiftMaskMap = packedInput.ase_texcoord7.zw * _ColorShiftMaskMap_ST.xy + _ColorShiftMaskMap_ST.zw;
				float4 transform376_g58579 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord8.xyz , 0.0 ));
				transform376_g58579.xyz = GetAbsolutePositionWS((transform376_g58579).xyz);
				float3 temp_output_337_0_g58579 = saturate( ( 1.0 - ( (( SAMPLE_TEXTURE2D( _ColorShiftMaskMap, sampler_MainTex, uv_ColorShiftMaskMap ) * transform376_g58579 )).rgb / max( _ColorShiftMaskFuzziness , 1E-05 ) ) ) );
				float3 lerpResult314_g58579 = lerp( hsvTorgb126_g58579 , BaseColor136_g58579 , temp_output_337_0_g58579);
				float3 lerpResult311_g58579 = lerp( BaseColor136_g58579 , hsvTorgb126_g58579 , temp_output_337_0_g58579);
				...
				float3 temp_cast_14 = (1.0).xxx;
				float2 uv_TransmissionMaskMap = packedInput.ase_texcoord7.zw * _TransmissionMaskMap_ST.xy + _TransmissionMaskMap_ST.zw;
				float3 lerpResult5_g58669 = lerp( temp_cast_14 , ( (SAMPLE_TEXTURE2D( _TransmissionMaskMap, sampler_TransmissionMaskMap, uv_TransmissionMaskMap )).rgb * _TransmissionMaskStrength ) , ( _TransmissionMaskEnable + ( ( _CATEGORY_TRANSMISSIONMASK + _SPACE_TRANSMISSIONMASK ) * 0.0 ) ));
